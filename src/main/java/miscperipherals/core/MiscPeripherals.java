...
import resonant.engine.content.ItemIngot;
...
@Mod(
		modid = "MiscPeripheralsX",
		name = "MiscPeripheralsX",
		version = "3.3.1",
...
public class MiscPeripherals {
	...
	public void onLoading(FMLInitializationEvent event) {
		...
		if (enableNote) {
			...
			GameRegistry.addRecipe(new ItemStack(blockAlpha, 1, 1), "IGI", "RNR", "IGI", 'I', new ItemIngot("minecraft:iron_ingot"), 'G', new ItemIngot("minecraft:gold_ingot"), 'R',  new ItemIngot("minecraft:redstone"), 'N', new BlockNote());
